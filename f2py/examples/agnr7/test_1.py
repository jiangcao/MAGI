...
if __name__=='__main__':   
   ...
   nnop=2
   nops=np.arange(nnop)*nstep + int(1.0 / dE)
   ...
   for iop in range(nnop):
      ...
      start_t = time.time()
      P_r[:,:,iop],nn = bse_dense.bse_fullsolve(
...
#                        eps_en=eps_en
   ...
   np.savez('data_ndiag'+str(ndiag)+'.npz', 
                        ...
                        Aupperarrow=Aupperarrow,
                        Alowerarrow=Alowerarrow,
        X_diagonal_blocks        =    X_diagonal_blocks,
        X_lower_diagonal_blocks  =    X_lower_diagonal_blocks,
        X_upper_diagonal_blocks  =    X_upper_diagonal_blocks,
        X_arrow_bottom_blocks    =    X_arrow_bottom_blocks,
        X_arrow_right_blocks     =    X_arrow_right_blocks,
        X_arrow_tip_block        =    X_arrow_tip_block, 
#                        ldos=ldos,
#                        ndos=ndos,
#                        eps_M=eps_M,
#                        eps_en=eps_en
