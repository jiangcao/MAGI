...
if __name__=='__main__':   
   ...
   nen_list = np.array([1000,2000,3000,5000,8000,10000],dtype='i')
   ...
   for i, toten in enumerate(nen_list):
      ...
      for j, nsub in enumerate(nsub_list):
         ...
         print(nen,nsub)
         G_retarded,G_lesser,G_greater,W0,tr = gf_dense.solve_gw_3d(niter=niter,nm_dev=nb*length,lx=Lx,length=length,spindeg=2.0,
